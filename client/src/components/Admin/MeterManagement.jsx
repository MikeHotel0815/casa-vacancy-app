        ...
        <div className="lg:col-span-2">
          {selectedMeter ? (
            ...
            <div className="p-10 bg-white rounded-lg shadow-md text-center text-gray-500 h-full flex flex-col justify-center items-center">
              {/* Großes SVG-Icon entfernt */}
              <p className="text-lg mb-2">Bitte wählen Sie einen Zähler aus der Liste.</p>
              <p className="text-sm">Oder legen Sie über den Button links einen neuen Zähler an.</p>
            </div>
          )}
        </div>
      </div>
